...
**Generated:** 2026-08-21T02:00:19.702547Z  
**Change units:** 272 · **Material:** 85  
...
**Implementation and interoperability** — 49 material change units, led by delivery and maintenance, credentials and proof.
...
| Governed action | **Advancing strongly** | 55 | 34 |
| Implementation and interoperability | **Advancing strongly** | 210 | 49 |
...
- **Credentials and evidence: specification and implementation are moving together.** The monitor observed 1 material specification change unit(s) and 39 material implementation change unit(s).
- **Governed action: specification and implementation are moving together.** The monitor observed 34 material specification change unit(s) and 49 material implementation change unit(s).
