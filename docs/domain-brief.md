...
**Generated:** 2026-09-10T16:29:35.921254Z  
**Evidence through:** 2026-09-10T16:17:02Z  
**Source revision:** `176244599c65c9a84a18dc25d922d5fee454a024` · **Collection run:** `34502271424` · **Publication state:** `workflow-generated`  
**Change units:** 840 · **Material:** 275  

This is the situational-awareness view of the monitored DTG portfolio. It interprets observed GitHub evidence through the declared [DTG domain model]({{ '/domain-model/' | relative_url }}). It is not an official ToIP architectural statement.

## Review queue

- **Decision findings:** 64
...
**Implementation and interoperability** — 121 material change units, led by delivery and maintenance, protocol and interoperability.
...
| Implementation and interoperability | **Advancing strongly** | 279 | 121 |
...
- **Credentials and evidence: specification and implementation are moving together.** The monitor observed 20 material specification change unit(s) and 102 material implementation change unit(s).
- **Governed action: specification and implementation are moving together.** The monitor observed 65 material specification change unit(s) and 113 material implementation change unit(s).
- **Governed action: specification and implementation are moving together.** The monitor observed 1 material specification change unit(s) and 113 material implementation change unit(s).
...
| `DTG-A-AE9E88364B393876` | watch | moving-together | Governed action specification and implementation are moving together in this window. |
...
| `DTG-A-3DFCC85667798F9C` | watch | observed | Material movement is present on both sides of the declared exercised-by relationship. |
...
| `DTG-A-0F8BF1C9DE4BC7AA` | watch | observed | Governed action has material activity while related capability Human trust and safety is quiet in this observation window. |
