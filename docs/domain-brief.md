...
**Implementation and interoperability** — 40 material change units, led by delivery and maintenance, protocol and interoperability.
**Governed action** — 26 material change units, led by delivery and maintenance, protocol and interoperability.
...
| Governed action | **Advancing strongly** | 37 | 26 |
| Implementation and interoperability | **Advancing strongly** | 106 | 40 |
...
- **Credentials and evidence: specification and implementation are moving together.** The monitor observed 2 material specification change unit(s) and 23 material implementation change unit(s).
- **Governed action: specification and implementation are moving together.** The monitor observed 26 material specification change unit(s) and 39 material implementation change unit(s).
