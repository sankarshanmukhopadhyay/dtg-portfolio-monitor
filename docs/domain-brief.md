...
**Generated:** 2026-09-09T04:49:48.368879Z  
**Evidence through:** 2026-09-09T01:49:05Z  
**Source revision:** `54c9f2198a8fb1f7e46e17e7dc1f9a794acd8a00` · **Collection run:** `34312388242` · **Publication state:** `workflow-generated`  
**Change units:** 598 · **Material:** 196  
...
**Governed action** — 43 material change units, led by delivery and maintenance, protocol and interoperability.
...
| Governed action | **Advancing strongly** | 180 | 43 |
| Implementation and interoperability | **Advancing strongly** | 184 | 83 |
...
- **Governed action: specification and implementation are moving together.** The monitor observed 41 material specification change unit(s) and 77 material implementation change unit(s).
...
| `DTG-A-9EB95134E1C7E999` | watch | moving-together | Governed action specification and implementation are moving together in this window. |
...
| `DTG-A-B8550AB0EBC9D2B0` | watch | observed | Material movement is present on both sides of the declared exercised-by relationship. |
...
| `DTG-A-056017D09AC99DBE` | watch | observed | Governed action has material activity while related capability Human trust and safety is quiet in this observation window. |
