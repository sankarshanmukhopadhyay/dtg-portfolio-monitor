...
**Generated:** 2026-08-24T13:16:40.419495Z  
**Change units:** 228 · **Material:** 79  
...
**Implementation and interoperability** — 60 material change units, led by delivery and maintenance, credentials and proof.
**Governed action** — 10 material change units, led by protocol and interoperability, delivery and maintenance.
...
| Governed action | **Advancing strongly** | 24 | 10 |
| Implementation and interoperability | **Advancing strongly** | 189 | 60 |
...
- **Credentials and evidence: specification and implementation are moving together.** The monitor observed 7 material specification change unit(s) and 47 material implementation change unit(s).
- **Governed action: specification and implementation are moving together.** The monitor observed 10 material specification change unit(s) and 60 material implementation change unit(s).
