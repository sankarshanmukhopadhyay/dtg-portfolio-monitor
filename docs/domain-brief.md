...
**Generated:** 2026-08-25T01:55:12.873217Z  
**Change units:** 236 · **Material:** 83  
...
| Implementation and interoperability | **Advancing strongly** | 193 | 64 |
...
- **Credentials and evidence: specification and implementation are moving together.** The monitor observed 7 material specification change unit(s) and 51 material implementation change unit(s).
- **Governed action: specification and implementation are moving together.** The monitor observed 10 material specification change unit(s) and 64 material implementation change unit(s).
